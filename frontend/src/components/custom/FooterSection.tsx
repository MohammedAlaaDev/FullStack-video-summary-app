...
function selectSocialIcon(url: string) {
    ...
    if (url.includes("x")) return <TwitterIcon className={styles.icon} />;
    return null;
}
...
export function FooterSection({ data }: IFooterProps) {
    if (!data) return null;
    const { logoLink, socialMedia, footerText } = data;
    return (
        <div className={styles.footer}>
            <div className={styles.container}>
                <Logo dark text={logoLink.label} />
